...
/**
 * Controlador REST para “Revision”. Todas las respuestas exitosas
 * usan ApiResponse o SuccessfulDeleteResponse para formatear JSON.
 */
@RestController
...
public class RevisionController {
    ...
    /**
     * DELETE /revisions/{id}
     * Elimina físicamente (real) la revisión.
     * Responde con status = "deleted".
     */
    @DeleteMapping("/{id}")
    public ResponseEntity<SuccessfulDeleteResponse> deleteRevision(@PathVariable Integer id) {
        ...
        SuccessfulDeleteResponse response =
                new SuccessfulDeleteResponse(
                        "deleted",
                        "Revisión con ID " + id + " eliminada correctamente.");
    ...
    /**
     * GET /revisions/visible
     * Lista solo las revisiones con isVisible = true.
     * Responde con status = "success".
     */
    @GetMapping("/visible")
    ...
    /**
     * GET /revisions/contact/{contactId}
     * Lista revisiones por ID de contacto.
     * Responde con status = "success".
     */
    @GetMapping("/contact/{contactId}")
    public ResponseEntity<ApiResponse<List<RevisionResponse>>> getRevisionsByContact(@PathVariable Integer contactId) {
    ...
    /**
     * GET /revisions/type/{typeId}
     * Lista revisiones por ID de tipo de revisión.
     * Responde con status = "success".
     */
    @GetMapping("/type/{typeId}")
    public ResponseEntity<ApiResponse<List<RevisionResponse>>> getRevisionsByType(@PathVariable Integer typeId) {
    ...
    /**
     * PATCH /revisions/{id}/visible
     * Marca una revisión como visible.
     * Responde con status = "updated".
     */
    @PatchMapping("/{id}/visible")
    public ResponseEntity<ApiResponse<RevisionResponse>> setRevisionVisible(@PathVariable Integer id) {
    ...
    /**
     * PATCH /revisions/{id}/invisible
     * Marca una revisión como invisible.
     * Responde con status = "updated".
     */
    @PatchMapping("/{id}/invisible")
    public ResponseEntity<ApiResponse<RevisionResponse>> setRevisionInvisible(@PathVariable Integer id) {
