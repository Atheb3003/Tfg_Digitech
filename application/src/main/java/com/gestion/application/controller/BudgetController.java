...
public class BudgetController {
  ...
  public ResponseEntity<BudgetResponse> createBudget(
      @PathVariable Long contactId, @RequestBody BudgetRequest request) {
  ...
  @GetMapping
  public ResponseEntity<List<BudgetResponse>> getBudgetsByContact(@PathVariable Long contactId) {
