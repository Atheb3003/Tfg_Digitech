...
public class TransactionDetailController {
  ...
  public ResponseEntity<ApiResponse<Page<SoldItemResponse>>> getVisibleSoldItems(Pageable pageable) {
  ...
  public ResponseEntity<IncomeByPaymentMethodResponse> getIncomeByPaymentMethod(
    ...
    return ResponseEntity.ok(
            service.getIncomeByPaymentMethod(startDate, endDate)
    );
  ...
  public ResponseEntity<ProductBreakdownResponse> getProductBreakdown(
    ...
    return ResponseEntity.ok(
            service.getProductBreakdown(start, end)
    );
  }
  ...
  public ResponseEntity<TypeBreakdownResponse> getTypeBreakdown(
    ...
    return ResponseEntity.ok(
            service.getTypeBreakdown(startDate, endDate)
    );
  }

  /** GET /transaction-details/detail-info/{id} */
  @GetMapping("/detail-info/{id}")
  public ResponseEntity<ApiResponse<TransactionDetailInfoResponse>> getTransactionDetailInfo(@PathVariable Integer id) {
