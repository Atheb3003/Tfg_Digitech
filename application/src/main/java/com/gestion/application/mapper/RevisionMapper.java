...
public class RevisionMapper {
    ...
    /**
     * Convierte de DTO a entidad (solo campos simples).
     * Relaciones (contact, type, protocol, idPatient) se asignan en el servicio.
     */
    ...
    public RevisionResponse toDto(Revision entity) {
        ...
        resp.setIdProtocol(entity.getProtocol() != null
                ? entity.getProtocol().getIdProtocol()
                : null);
