...
class GetAllRevisionsImplTest {
  ...
  @Test
  void execute_returnsMappedRevisionResponses() {
    ...
    when(revisionRepository.findAll()).thenReturn(Arrays.asList(rev1, rev2));
