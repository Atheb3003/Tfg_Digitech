...
class SetRevisionVisibleImplTest {
  ...
  @Test
  void execute_existingRevision_setsVisibleAndReturnsDto() {
    Integer id = 8;
    Revision revision = new Revision();
    revision.setIsVisible(false);

    Revision savedRevision = new Revision();
    savedRevision.setIsVisible(true);
    ...
    assertTrue(revision.getIsVisible());
