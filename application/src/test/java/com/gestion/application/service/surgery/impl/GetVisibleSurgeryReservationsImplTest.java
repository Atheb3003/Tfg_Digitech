...
class GetVisibleSurgeryReservationsImplTest {

  @Mock private SurgeryReservationRepository reservationRepository;

  @InjectMocks private GetVisibleSurgeryReservationsImpl service;
  ...
  @Test
  void getVisible_shouldReturnPagedResponses() {
    Pageable pageable = PageRequest.of(0, 10);

    Contact contact = new Contact();
    contact.setIdContact(400);
    contact.setIdContactString("CT400");
    contact.setName("Diana");
    contact.setSurname("Prince");

    Patient patient = new Patient();
    patient.setIdPatient(4);
    patient.setContact(contact);

    SurgeryReservation reservation = new SurgeryReservation();
    reservation.setIdSurgeryReservation(40);
    reservation.setPatient(patient);
    reservation.setDescription("Visible Reservation");
    reservation.setFollicularUnits(90);
    reservation.setSurgicalTechnique("Technique V");
    reservation.setEstimatedDate(LocalDate.now().plusDays(8));
    reservation.setNational(true);
    reservation.setDeposit(BigDecimal.valueOf(350));
    reservation.setRemainingMoney(BigDecimal.valueOf(650));
    ...
    Page<SurgeryReservationResponse> result = service.getVisible(pageable);
    ...
    assertEquals("Diana Prince", dto.getContactFullName());
